...
public class HashTable_ALT {
    private FruitNode[] ht;

    public HashTable_ALT(int size) {        // DONT Change
    ...
    public void insert(String key, Integer value) {
        ...
        n0 = ht[idx];
        n1 = n0.next;
        while (n1 != null) {                    // collision + new key
            int v = (int)n1.fruit[1];
