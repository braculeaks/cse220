public class AssignmentTask4 {
    ...
    {   
        Node newTree = new Node(head1.elem);        // head1 will have 4 elems guranteed
        Node h = newTree;
        Node tail = newTree;
        ...
        while (true) {
            ...
            int sum = (int)tmp2.elem + (int)tmp3.elem;
            Node n0 = new Node(sum % 10);
            tail.next = n0;
            tail = n0;
